...
<!-- Image  -->
  ...
  <?php endif; ?>
        ...
        <?php if ($this->params->get('user_hover')): ?>
          ...
          <div class="item_more">
            <a href="<?php echo htmlspecialchars($images->image_fulltext); ?>" class="galleryZoom"><i class="icon-zoom-in"></i></a>
            <?php if ($params->get('show_readmore') && $this->item->readmore) : ?>
              <a href="<?php echo $link; ?>" class="hover_more"><i class="icon-signin"></i></a>
            <?php endif; ?>
          </div>
