...
?>
<div class="page-item page-item__gallery page-item__<?php echo $this->pageclass_sfx?>">
...
?>
	...
	<div class="item_header">
		<?php echo '<'. $template->params->get('itemItemHeading') .' class="item_title">'; ?>
			...
			<?php endif; ?>
		<?php echo '</'. $template->params->get('itemItemHeading') .'>'; ?>
