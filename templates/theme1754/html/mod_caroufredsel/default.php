...
<div class="mod_caroufredsel mod_caroufredsel__<?php echo $moduleclass_sfx; ?>">
	<div id="list_carousel_<?php echo $params->get('carousel_id'); ?>" class="list_carousel">
		...
		<?php if ($params->get('navigation')): ?>
			<div id="carousel_<?php echo $params->get('carousel_id'); ?>_prev" class="caroufredsel_prev"><i class="icon-chevron-left"></i></div>
			<div id="carousel_<?php echo $params->get('carousel_id'); ?>_next" class="caroufredsel_next"><i class="icon-chevron-right"></i></div>
		<?php endif; ?>
